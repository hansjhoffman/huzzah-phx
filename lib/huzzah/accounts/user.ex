defmodule Huzzah.Accounts.User do
  @moduledoc """
  User schema
  """
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Huzzah.Repo)
  ...
  defp validate_handle(changeset) do
    ...
    |> unsafe_validate_unique(:handle, Huzzah.Repo)
  ...
  @doc """
  A user changeset for changing their handle.
  ...
  """
  def valid_password?(%Huzzah.Accounts.User{hashed_password: hashed_password}, password)
